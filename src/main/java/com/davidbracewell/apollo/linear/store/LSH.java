...
public abstract class LSH implements Serializable {
    ...
    * @param vectorID the NDArray id
    */
   public void add(@NonNull NDArray NDArray, int vectorID) {
      int[] hash = hash(NDArray);
   ...
   /**
    * Gets the NDArray ids for the given band and bucket
    *
    * @param band   the band
    * @param bucket the bucket
    * @return the NDArray ids
    */
   ...
   /**
    * Gets the ids of vectors close to the given NDArray
    *
    * @param NDArray the NDArray
    * @return the int ids of the nearest vectors
    */
   public OpenIntHashSet query(@NonNull NDArray NDArray) {
   ...
   /**
    * Removes the NDArray with the given NDArray id from the LSH table.
    *
    * @param NDArray  the NDArray
    * @param vectorID the NDArray id
    */
   public void remove(NDArray NDArray, int vectorID) {
      if (NDArray != null) {
         int[] hash = hash(NDArray);
         for (int band = 0; band < bands; band++) {
   ...
   /**
    * Removes the NDArray associated with the given NDArray id from the LSH table.
    *
    * @param vectorID the NDArray id
    */
   ...
   public abstract static class Builder {
      ...
      /**
       * Create NDArray store NDArray store.
       *
       * @param <KEY> the type parameter
       * @return the NDArray store
       */
