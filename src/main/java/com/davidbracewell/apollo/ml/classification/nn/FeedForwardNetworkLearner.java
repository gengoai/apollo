...
import com.davidbracewell.apollo.ml.optimization.AdamUpdater;
import com.davidbracewell.apollo.ml.optimization.SGDUpdater;
import com.davidbracewell.apollo.ml.optimization.TerminationCriteria;
...
//                                                 iteration)));
////         for (List<NDArray> tuple2s : com.davidbracewell.guava.common.collect.Lists.partition(batches,
////                                                                                              (int) Math.ceil(
////                                                                                                 batches.size() / 4))) {
