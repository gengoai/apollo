 ...
 */
public abstract class SimilarityMeasure implements Serializable, ContingencyTableCalculator {
   ...
   * @return the double
   */
  public double calculate(@NonNull Counter<?> v1, @NonNull Counter<?> v2) {
   ...
   * @return the double
   */
  public double calculate(@NonNull Set<?> s1, @NonNull Set<?> s2) {
    return calculate(
