 ...
 */
public class NameFilterTest extends BaseInstancePreprocessorTest {
   ...
   public void test() throws Exception {
      ...
      assertFalse(featureNames.contains("sepal_length"));
      assertFalse(featureNames.contains("sepal_width"));
